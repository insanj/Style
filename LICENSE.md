Minor markdown formatting and layout derivations from the [New York Times Objective-C Style Guide](https://github.com/NYTimes/objective-c-style-guide/) under the [MIT License](https://github.com/NYTimes/objective-c-style-guide/blob/master/LICENSE).
